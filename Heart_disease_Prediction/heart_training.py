...
class HeartClassification():
    ...
    def create_pipeline(self):
        '''
        heart disease Data training and Validation
        '''        
    ...
    def create_outputs(self, y_true, y_pred, X_test, name):
        ...
        '''
        pred_output = {"Actual target" : y_true['target'].values, "Predicted Species": y_pred['target'].values}        
    ...
    def validate(self, y_true, y_pred, X_test):
        ...
        self.run.tag("heartClassifierFinalRun")        
...
if __name__ == "__main__":
    ...
    heart_classifier = HeartClassification(args)
    heart_classifier.create_pipeline()