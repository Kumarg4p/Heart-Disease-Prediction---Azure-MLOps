...
# Introduction 
Fully Automated end-to-end Training and Deployment of Heart Disease Prediction Classifer using Azure MLOps
# Prerequisites
...
2. Create a Project named Heart Disease Prediction
